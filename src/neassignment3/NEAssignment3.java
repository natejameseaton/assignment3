...
public class NEAssignment3 {
    ...
    public static void main(String[] args) {
        ...
        // Retrieve customer id for cust table
        System.out.println("Enter the customer id:");
            int customerId = keyboard.nextInt();
        
        // Retrieve product id for product table
        System.out.println("Enter the product id:");
            int productId = keyboard.nextInt();
            
        // Retrieve order number, quantity, shipping cost, sales date
        // Shipping date, fright company for purchase_order table
        System.out.println("Enter the product id:");
        ...
        String sqlb = "SELECT CUSTOMER_ID, DISCOUNT_CODE, ZIP, NAME, ADDRESSLINE1, "
